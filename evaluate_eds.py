...
def evaluate(
    ...
    results = {}
    for scene in test_split:#遍历每一个场景
...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights", default="dpvo.pth") #权重文件
    parser.add_argument("--config_VO", default="config/default.yaml") #VO的参数文件（跟DPVO差不多）
    parser.add_argument("--config_eval", type=str, default="config/TartanEvent.json") #评估的参数文件（主要应该是数据的路径）
